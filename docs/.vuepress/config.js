module.exports = {
  title: 'Vue Storefront 2 for omneo',
  base: '/',
  description: 'Documentation for the omneo connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/omneo',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/omneo'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/omneo'}
    ],
    sidebar: [
      {
        title: 'Essentials',
