...
## Vue Storefront 2 integration with omneo
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/omneo.git
    cd omneo
    ```
...
- [omneo integration Documentation](https://docs.vuestorefront.io/omneo)
